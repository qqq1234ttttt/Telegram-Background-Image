...
# ==================== 1. DUMMY WEB SERVER (FOR RENDER.COM) ====================
# Render requires a web service to bind to a port on 0.0.0.0
...
# user_state: 0 = waiting for background image, 1 = waiting for main image
user_state = {}
